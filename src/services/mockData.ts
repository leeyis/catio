...
const tableStructures: Record<string, TableStructure> = {
  orders: {
    comment: '订单主表 · 每行一笔订单',
    columns: [
      { name: 'id', type: 'bigint', nullable: false, default: "nextval('orders_id_seq')", key: 'PK', extra: 'identity', comment: '' },
      { name: 'customer_id', type: 'bigint', nullable: false, default: null, key: 'FK', extra: '→ customers.id', comment: '' },
      { name: 'status', type: 'order_status', nullable: false, default: "'pending'", key: '', extra: 'enum', comment: '' },
      { name: 'total_cents', type: 'integer', nullable: false, default: '0', key: '', extra: 'check ≥ 0', comment: '' },
      { name: 'currency', type: 'char(3)', nullable: false, default: "'USD'", key: '', extra: '', comment: '' },
      { name: 'items', type: 'smallint', nullable: false, default: '1', key: '', extra: '', comment: '' },
      { name: 'channel', type: 'varchar(16)', nullable: true, default: null, key: '', extra: '', comment: '' },
      { name: 'created_at', type: 'timestamptz', nullable: false, default: 'now()', key: '', extra: '', comment: '' },
      { name: 'updated_at', type: 'timestamptz', nullable: false, default: 'now()', key: '', extra: '', comment: '' },
    ] as StructColumn[],
    indexes: [
  ...
  customers: {
    comment: '客户表',
    columns: [
      { name: 'id', type: 'bigint', nullable: false, default: "nextval('customers_id_seq')", key: 'PK', extra: 'identity', comment: '' },
      { name: 'email', type: 'citext', nullable: false, default: null, key: 'UNI', extra: '', comment: '' },
      { name: 'full_name', type: 'varchar(120)', nullable: false, default: null, key: '', extra: '', comment: '' },
      { name: 'country', type: 'char(2)', nullable: true, default: null, key: '', extra: '', comment: '' },
      { name: 'tier', type: 'varchar(12)', nullable: false, default: "'standard'", key: '', extra: '', comment: '' },
      { name: 'created_at', type: 'timestamptz', nullable: false, default: 'now()', key: '', extra: '', comment: '' },
      { name: 'deleted_at', type: 'timestamptz', nullable: true, default: null, key: '', extra: 'soft-delete', comment: '' },
    ] as StructColumn[],
    indexes: [
  ...
  line_items: {
    comment: '订单明细行',
    columns: [
      { name: 'id', type: 'bigint', nullable: false, default: 'identity', key: 'PK', extra: '', comment: '' },
      { name: 'order_id', type: 'bigint', nullable: false, default: null, key: 'FK', extra: '→ orders.id', comment: '' },
      { name: 'product_id', type: 'bigint', nullable: false, default: null, key: 'FK', extra: '→ products.id', comment: '' },
      { name: 'qty', type: 'smallint', nullable: false, default: '1', key: '', extra: '', comment: '' },
      { name: 'unit_cents', type: 'integer', nullable: false, default: '0', key: '', extra: '', comment: '' },
      { name: 'discount_cents', type: 'integer', nullable: false, default: '0', key: '', extra: '', comment: '' },
    ] as StructColumn[],
    indexes: [
  ...
  payments: {
    ...
    columns: [
      { name: 'id', type: 'bigint', nullable: false, default: 'identity', key: 'PK', extra: '', comment: '' },
      { name: 'order_id', type: 'bigint', nullable: false, default: null, key: 'FK', extra: '→ orders.id', comment: '' },
      { name: 'provider', type: 'varchar(20)', nullable: false, default: null, key: '', extra: '', comment: '' },
      { name: 'amount_cents', type: 'integer', nullable: false, default: '0', key: '', extra: '', comment: '' },
      { name: 'state', type: 'payment_state', nullable: false, default: "'init'", key: '', extra: 'enum', comment: '' },
      { name: 'captured_at', type: 'timestamptz', nullable: true, default: null, key: '', extra: '', comment: '' },
    ] as StructColumn[],
    indexes: [
  ...
  products: {
    ...
    columns: [
      { name: 'id', type: 'bigint', nullable: false, default: 'identity', key: 'PK', extra: '', comment: '' },
      { name: 'sku', type: 'varchar(32)', nullable: false, default: null, key: 'UNI', extra: '', comment: '' },
      { name: 'title', type: 'varchar(200)', nullable: false, default: null, key: '', extra: '', comment: '' },
      { name: 'price_cents', type: 'integer', nullable: false, default: '0', key: '', extra: '', comment: '' },
      { name: 'active', type: 'boolean', nullable: false, default: 'true', key: '', extra: '', comment: '' },
    ] as StructColumn[],
    indexes: [
  ...
  refunds: {
    ...
    columns: [
      { name: 'id', type: 'bigint', nullable: false, default: 'identity', key: 'PK', extra: '', comment: '' },
      { name: 'payment_id', type: 'bigint', nullable: false, default: null, key: 'FK', extra: '→ payments.id', comment: '' },
      { name: 'amount_cents', type: 'integer', nullable: false, default: '0', key: '', extra: '', comment: '' },
      { name: 'reason', type: 'varchar(120)', nullable: true, default: null, key: '', extra: '', comment: '' },
      { name: 'created_at', type: 'timestamptz', nullable: false, default: 'now()', key: '', extra: '', comment: '' },
    ] as StructColumn[],
  ...
  shipments: {
    ...
    columns: [
      { name: 'id', type: 'bigint', nullable: false, default: 'identity', key: 'PK', extra: '', comment: '' },
      { name: 'order_id', type: 'bigint', nullable: false, default: null, key: 'FK', extra: '→ orders.id', comment: '' },
      { name: 'carrier', type: 'varchar(24)', nullable: false, default: null, key: '', extra: '', comment: '' },
      { name: 'tracking_no', type: 'varchar(40)', nullable: true, default: null, key: '', extra: '', comment: '' },
      { name: 'shipped_at', type: 'timestamptz', nullable: true, default: null, key: '', extra: '', comment: '' },
    ] as StructColumn[],
